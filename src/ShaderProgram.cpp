...
void VertexShaderProgram::update_camera(const glm::mat4 view,
                                        const glm::vec3 eye) {
	m_program->setUniform("view", view);
	m_program->setUniform("eyePos", eye);
}

void VertexShaderProgram::use_textures(const globjects::Texture* diffuse,
...
void FragmentShaderProgram::update_transforms(const glm::mat4 model,
                                              const glm::mat4 view,
